...
namespace NetService.Util
{
    ...
    public class BinaryWriter
    {
        ...
        public void Write(NetService.Util.BinaryWriter writer)
        {
    ...
    /* 
     * 
        static void TestBinaryWriterReader()
        {
            BinaryWriter w = new BinaryWriter(100);
            w.WriteBool(true);
            w.WriteBool(false);
            w.WriteByte(1);
            w.WriteSByte(2);
            ...
            w.WriteUInt64(8);
            w.WriteString("스트링");
            BinaryReader r = new BinaryReader(w);
            Debug.Assert(r.ReadBool() == true);
            Debug.Assert(r.ReadBool() == false);
            Debug.Assert(r.ReadByte() == 1);
            Debug.Assert(r.ReadSByte() == 2);
            Debug.Assert(r.ReadInt16() == 3);
            Debug.Assert(r.ReadUInt16() == 4);
            Debug.Assert(r.ReadInt32() == 5);
            Debug.Assert(r.ReadUInt32() == 6);
            Debug.Assert(r.ReadInt64() == 7);
            Debug.Assert(r.ReadUInt64() == 8);
